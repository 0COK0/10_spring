...
public class Application {
    ...
    private static Map<String, String> inputModifyEmployee() {
        ...
        String deptCode2 = sc.nextLine();
        System.out.print("수정할 직원 직급 코드를 수정해주세요 : ");
        String jobCode2 = sc.nextLine();
        System.out.print("수정할 직원 급여 등급을 수정해주세요 : ");
        String salLevel2 = sc.nextLine();
        System.out.print("수정할 직원 급여를 수정해주세요 : ");
        String salary2 = sc.nextLine();
        System.out.print("수정할 직원 보너스를 수정해주세요 : ");
        String bonus2 = sc.nextLine();
        System.out.print("수정할 직원의 입사일을 수정해주세요 : ");
        String hireDate2 = sc.nextLine();
        System.out.print("수정할 직원의 퇴사일을 수정해주세요 : ");
        String entDate2 = sc.nextLine();
        System.out.print("수정할 퇴직 여부를 수정해주세요 : ");
        String entYn2 = sc.nextLine();

// HashMap클래스에 parameter라는 새로운 맵을 생성해 키와 값<String> 데이터 저장
        Map<String, String> parameter = new HashMap<>();
// parameter 맵에 "empId"키와 empId 값을 추가(변수는 직원의 ID) 저장하는 역할
        parameter.put("empId", empId2);
        parameter.put("empName", empName2);
        parameter.put("empNo", empNo2);
        parameter.put("email", email2);
        parameter.put("phone", phone2);
        parameter.put("deptCode", deptCode2);
        parameter.put("jobCode", jobCode2);
        parameter.put("salLevel", salLevel2);
        parameter.put("salary", salary2);
        parameter.put("bonus", bonus2);
        parameter.put("hireDate", hireDate2);
        parameter.put("entDate", entDate2);
        parameter.put("entYn", entYn2);
